        ...
        <div class="row">
           ...
           <div class="col-12">
            <div class="card">
              ...
              <!-- Multi Columns Form -->
              <form action="/agendabaru" method="POST" enctype="multipart/form-data">
                @csrf
              <form class="row g-3">
                <div class="col-md-12">
                  <label for="inputNama5" class="form-label" >Nama Agenda</label>
                  <input type="text" class="form-control" placeholder="Masukkan Nama Lengkap" id="inputNama5" name="namaagenda">
                </div>
                <div class="col-md-12">
                  <label for="inputNama5" class="form-label" >Keterangan</label>
                  <input type="text" class="form-control" placeholder="Masukkan Nama Lengkap" id="inputNama5" name="keterangan">
                </div>
                <div class="col-md-12">
