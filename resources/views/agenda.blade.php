    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
                <div class="search-bar">
                    <form class="search-form d-flex align-items-center" action="/agenda" method="GET">
                ...
                <div class="tab-pane fade show active datapenduduk-kk1" id="datapenduduk-kk1">
                  ...
                  <p> </p>
                            <div class="table-responsive">
                              <table id="example1" class="table table-bordered table-striped">
                                <thead class="table-white align-items-center">
                                  ...
                                  <tr>
                                    ...
                                    <th width="200px" scope="col">Keterangan</th>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                  <td>{{ $key + 1 }}</td>
                                      <td>{{$row -> namaagenda}}</td>
                                    <td>{{$row -> keterangan}}</td>
                                    <td>
                                      <img src="{{ asset('fotoagenda/'.$row->foto) }}" alt="" style="width: 40px;">
                                    </td>
                                    ...
                                    <td>
                                    <div class="text-start">
                                    <a href="/tampilkanagenda/{{$row -> id}} type="button" class="btn btn-primary">Edit</button>
                              ...
                              @endforeach<!-- End Vertically centered Modal-->
                                    </div>
