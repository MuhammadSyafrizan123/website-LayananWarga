            ...
            <div class="card">
              ...
              <form class="row g-3">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan Nama Lengkap" id="inputNama5" name="nama_lengkap" value="{{ $data -> nama_lengkap}}">
                </div>
                <div class="col-md-12">
                  <label for="inputkelamin5" class="form-label">Jenis Kelamin</label>
                  <select id="inputkelamin5" class="form-select" name="jenis_kelamin" value="{{ $data -> jenis_kelamin}}">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan NIK" id="inputnik5s" name="no_nik" value="{{ $data -> no_nik}}">
                </div>
                <div class="col-md-12">
                  <label for="inputnokk5" class="form-label">MNomor Induk Keluarga (KK) </label>
                  <input type="text" class="form-control" placeholder="Masukkan No KK" id="inputnokk5s" name="no_kk" value="{{ $data -> no_kk}}">
                </div>
                <div class="col-md-12">
                  <label for="inputpekerjaan5" class="form-label">Pekerjaan</label>
                  <select id="inputpekerjaan5" class="form-select" name="pekerjaan" value="{{ $data -> pekerjaan}}">
                    <option selected>Pilih Salah Satu...</option>
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan Alamat" id="inputalamat5s" name="alamat" value="{{ $data -> alamat}}">
                </div>
                <div class="col-md-12">
                  <label for="inputkelamin5" class="form-label">Pilih RT</label>
                  <select id="inputkelamin5" class="form-select" name="rt" value="{{ $data -> rt}}">
                    <option selected>Pilih Salah Satu...</option>
                ...
                <div class="col-md-12">
                  ...
                  <select id="inputkelamin5" class="form-select" name="rw" value="{{ $data -> rw}}">
                    <option selected>Pilih Salah Satu...</option>
                    <option value="012">012x</option>
                   </select>
                </div>
                <div class="col-md-12">
                  <label for="inputnotelp5" class="form-label">Masukkan No Telepon</label>
                  <input type="text" class="form-control" placeholder="Masukkan No Telepon" id="inputnotelp5s" name="no_hp" value="{{ $data -> no_hp}}">
                </div>
